            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <?php echo form_open_multipart("admin/panduan/update") ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Judul Panduan" name="panduan_title" required="required" value="<?php echo $panduan[0]->panduan_title; ?>">
                                        <input type="hidden" class="form-control" name="panduan_id" required="required" value="<?php echo $panduan[0]->panduan_id; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Isi Panduan <span style="color:red">*</span></b></label>
                                        <textarea cols="80" id="editor" name="panduan_deskripsi" rows="10" style="resize:none;max-width:700px;"><?php echo $panduan[0]->panduan_deskripsi; ?></textarea>
                                    </div>
