                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <div class="box-tools pull-left">
                                <div class="form-inline">
                                    ...
                                    <div class="input-group margin">
                                        <?php echo form_open("admin/panduan/search") ?>
                            ...
                            <div class="box-tools pull-right">
                                <div style="padding-top:10px">
                                    <a href="<?php echo site_url('admin/panduan') ?>" class="btn btn-success btn-flat" title="Refresh halaman">refresh</a>
                                    <a href="<?php echo site_url('admin/panduan/create_page') ?>" class="btn btn-primary btn-flat" title="Refresh halaman"> tambah</a>
                                </div>
                                ...
                                <div class="modal fade" id="modalCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <?php echo form_open("admin/panduan/create") ?>
                                            <div class="modal-body">
                                                <?php echo csrf(); ?>
                                                <div class="form-group">
                                                    <label for=""><b style="color: black">Judul Panduan <span style="color:red">*</span></b></label>
                                                    <textarea class="form-control" name="panduan_title" placeholder="Judul Panduan" rows="3" required></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for=""><b style="color: black">Isi Panduan <span style="color:red">*</span></b></label>
                                                    <textarea cols="80" id="editor" name="panduan_deskripsi" rows="10" style="resize:none;max-width:700px;" required></textarea>
                                                </div>
                                            </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo $key->panduan_title; ?></td>
                                        </tr>

                                        <!-- Modal Delete-->
                                        <div class="modal fade" id="modalDelete<?php echo $key->panduan_id ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <?php echo form_open("admin/panduan/delete") ?>
                                                    <div class="modal-body">
                                                        Apakah anda yakin akan menghapus data panduan : "<?php echo $key->panduan_title; ?>" ?
                                                        <?php echo csrf(); ?>
                                                        <input type="hidden" class="form-control" placeholder="Judul Panduan" name="panduan_title" required="required" value="<?php echo $key->panduan_title; ?>">
                                                        <input type="hidden" class="form-control" name="panduan_id" required="required" value="<?php echo $key->panduan_id; ?>">
                                                    </div>
                                                    <div class="modal-footer">
                        ...
                        <div class="box-footer">
                            ...
                            <!-- COUNT DATA -->
                            <?php if ($panduan) { ?>
                                <div class="float-left">Tampil <?php echo ($nox + $numbers) . " - " . (count($panduan) + $numbers) . " dari " . $total_data; ?> Data</div>
                            <?php } else { ?>
