                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <div class="box-tools pull-left">
                                <div class="form-inline">
                                    ...
                                    <div class="input-group margin">
                                        <?php echo form_open("admin/doa/search") ?>
                            ...
                            <div class="box-tools pull-right">
                                <div style="padding-top:10px">
                                    ...
                                    <a href="<?php echo site_url('admin/doa') ?>" class="btn btn-success btn-flat" title="Refresh halaman">refresh</a>
                                    <a href="<?php echo site_url('admin/doa/create_page') ?>" class="btn btn-primary btn-flat" title="Tambah data"> tambah</a>
                                </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('admin/doa/detail_page/' . $key->doa_id); ?>" class="btn btn-xs btn-flat btn-info">detail</a>
                                                <a href="<?php echo site_url('admin/doa/update_page/' . $key->doa_id) ?>" class="btn btn-xs btn-flat btn-warning">update</a>
                                        ...
                                        <!-- Modal Delete-->
                                        <div class="modal fade" id="modalDelete<?php echo $key->doa_id; ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                        ...
                        <div class="box-footer">
                            ...
                            <!-- COUNT DATA -->
                            <?php if ($doa) { ?>
                                <div class="float-left">Tampil <?php echo ($nox + $numbers) . " - " . (count($doa) + $numbers) . " dari " . $total_data; ?> Data</div>
                            <?php } else { ?>
