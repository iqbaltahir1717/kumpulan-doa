                ...
                <section class="content">
                    <div class="box">
                            ...
                            <table class="table table-bordered">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-xs btn-flat btn-info" data-toggle="modal" data-target="#modalDetail<?php echo $key->riwayat_id; ?>">detail</button>
                                                <button class="btn btn-xs btn-flat btn-warning" data-toggle="modal" data-target="#modalUpdate<?php echo $key->riwayat_id; ?>">update</button>
                                                <button class="btn btn-xs btn-flat btn-danger" data-toggle="modal" data-target="#modalDelete<?php echo $key->riwayat_id ?>">hapus</button>
                                            </td>
                                            <td><?php echo $key->riwayat_name; ?></td>
                                        </tr>

                                        <!-- Modal Update-->
                                        <div class="modal fade" id="modalUpdate<?php echo $key->riwayat_id ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                        ...
                                        <!-- Modal Delete-->
                                        <div class="modal fade" id="modalDelete<?php echo $key->riwayat_id ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <?php echo form_open("admin/riwayat/delete") ?>
                                                    <div class="modal-body">
                                        ...
                                        <!-- Modal Detail-->
                                        <div class="modal fade" id="modalDetail<?php echo $key->riwayat_id ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                        ...
                        <div class="box-footer">
                            ...
                            <!-- COUNT DATA -->
                            <?php if ($riwayat) { ?>
                                <div class="float-left">Tampil <?php echo ($nox + $numbers) . " - " . (count($riwayat) + $numbers) . " dari " . $total_data; ?> Data</div>
                            <?php } else { ?>
